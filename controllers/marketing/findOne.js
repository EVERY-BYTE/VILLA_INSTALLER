...
const findOne = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(marketingSchema_1.findMarketingSchema, req.params);
    if (error) {
    ...
    try {
        ...
        logger_1.default.info('Marketing record found successfully');
